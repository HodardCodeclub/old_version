...
{
	$cn=makeconnection();
	$s="insert into users values(NULL,'".$_POST['unames']."','".$_POST['umail']."','" . $_POST["t1"] ."','" . $_POST["t2"] . "','" . $_POST["s1"] . "')";
...
<tr><td class="lefttxt">Names</td><td><input type="text" name="unames" required pattern="[a-zA-z1 _]{3,50}" title"Please Enter Only Characters and numbers between 3 to 50 for User name" /></td></tr>
<tr><td class="lefttxt">Email</td><td><input type="text" name="umail" required pattern="[a-zA-z1 _@.]{3,50}" title"Please Enter Only Characters and numbers between 3 to 50 for User name" /></td></tr>
