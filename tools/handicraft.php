				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav cl-effect-18" id="cl-effect-18">
                            ...
                            <li><a href="breaking.html">Museums</a></li>
							...
							<li role="presentation" class="dropdown">
								...
								<ul class="dropdown-menu">
								  ...
								  <li><a href="short-codes2.html">Member</a></li>
								  <li><a href="short-codes3.html">Donate</a></li>
								</ul>
							</li>
				...
				<div class="news">
					<div class="news-grids">
						<div class="col-md-8 news-grid-left">
							<h3>latest news about Handicraft</h3>
							<ul>
								<li>
									...
									<div class="news-grid-right1">
										<h4><a href="single.html">Rwandan basketmakers weave their way into Macy’s </a></h4>
										<h5>By <a href="#">Hodard Hazwinayo</a> <label>|</label> <i>1.1.2017</i></h5>
										<p>Inside the Gahaya Links workshop on the outskirts of Kigali, Rwanda’s capital, a group of women sit side by side against a brightly-painted wall. Using natural fibers and grasses, they pool their weaving skills to create exquisite hand-made baskets.</p>
									</div>
								...
								<li>
									...
									<div class="news-grid-right1">
										<h4><a href="single.html">Gahaya Links is recognized with the Artisan Hero Award 2016 </a></h4>
										<h5>By <a href="#">Albert Ikuzwe</a> <label>|</label> <i>1.1.2017</i></h5>
										<p>Gahaya Links in Rwanda is recognised with Artisan Hero Award 2015 by the Alliance for Artisan Enterprise and The Aspen Institute.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									...
									<div class="news-grid-right1">
										<h4><a href="single.html">How to Weave Handmade Baskets </a></h4>
										<h5>By <a href="#">Frank Kabanda</a> <label>|</label> <i>1.1.2017</i></h5>
										<p>There are many steps that go into weaving baskets. Weavers who create beautiful baskets for Macy’s Rwanda Path to Peace show the steps.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									...
									<div class="news-grid-right1">
										<h4><a href="single.html"> Rwandan weavers craft 10-year anniversary designs</a></h4>
										<h5>By <a href="#">James Rwigema</a> <label>|</label> <i>31.12.2016</i></h5>
										<p>The festive in-store celebration featured live musical performances, traditional Rwandan food and a ceremony honoring the women who made this project possible.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									...
									<div class="news-grid-right1">
										<h4><a href="single.html"> A Lesson From Rwandan Basket Weavers </a></h4>
										<h5>By <a href="#">Michael Drew</a> <label>|</label> <i>6.1.2017</i></h5>
										<p>Reposted from the Huffington Post    For most working women and men in America today, finding a healthy work-life balance can be challenging to say the least.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
							</ul>
