				...
				<div class="news">
					<div class="news-grids">
						<div class="col-md-8 news-grid-left">
							<h3>latest news about Sports</h3>
							<ul>
								<li>
									<div class="news-grid-left1">
										<img src="images/sport1.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html">Anis Ben-Hatira: Darmstadt release player over Islamic charity link </a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>21.2.2017</i></h5>
										<p>Bundesliga club Darmstadt have released Tunisian midfielder Anis Ben-Hatira by mutual consent following criticism of his ties with an Islamic charity.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									<div class="news-grid-left1">
										<img src="images/sport5.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html">Asamoah Gyan deemed to have ’unethical hair’ in United Arab Emirates </a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>21.2.2017</i></h5>
										<p>Former Sunderland striker Asamoah Gyan is among a group of more than 40 players deemed to have "unethical hair" under United Arab Emirates Football Association (UAEFA) guidelines.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									<div class="news-grid-left1">
										<img src="images/sport2.png" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html">Handball League: Police ready for showdown </a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>21.2.2017</i></h5>
										<p>The five-time national handball league champions – Police Handball Club – is well prepared and ready to defend their trophy when the 2017 league edition kicks off this weekend, the club coach has said.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									<div class="news-grid-left1">
										<img src="images/sport3.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html"> RDF teams win Football Competitions for Heroes Day Celebration</a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>31.12.2016</i></h5>
										<p>Football games marking Heroes day celebrations took place on 1st February 2017, at Amahoro Stadium where APR FC has won the Heroes Day cup against Rayon Sports (1-0).</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									<div class="news-grid-left1">
										<img src="images/sport4.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html"> How Africa voted Onyango for African Player of the Year</a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>16.2.2017</i></h5>
										<p>Like most reputable accolades, the Caf awards had a decision making process that was used to determine winners of the various categories in two phases.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
							</ul>
