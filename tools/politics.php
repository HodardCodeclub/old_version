				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav cl-effect-18" id="cl-effect-18">
							...
							<li><a href="events.html">Rwandan Dance</a></li>
							<li><a href="breaking.html">Art & Craft</a></li>
							<li><a href="entertainment.html">Miss Rwanda</a></li>
							...
							<li role="presentation" class="dropdown">
								...
								<ul class="dropdown-menu">
								  <li><a href="short-codes1.html">Partern</a></li>
				...
				<div class="news">
					<div class="news-grids">
						<div class="col-md-8 news-grid-left">
							<h3>latest news about politics</h3>
							<ul>
								<li>
									<div class="news-grid-left1">
										<img src="images/politic1.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html">Trust: key link to building sustainable systems – Kagame </a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>19.2.2017</i></h5>
										<p>President Kagame, Microsoft founder Bill Gates and Erna Solberg, Prime Minister of the Kingdom of Norway speak on a panel discussion at the "Health Security: Small bugs, Big Bombs" conference in Munich, Germany yesterday. (Village Urugwiro)</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									<div class="news-grid-left1">
										<img src="images/politic4.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html">Burundi govt again refuses crisis talks with opposition </a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>15.2.2017</i></h5>
										<p>Violence erupted when President Pierre Nkurunziza decided to run for a third term in office in April 2015. At least 300,000 people have fled the country.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									<div class="news-grid-left1">
										<img src="images/politic3.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html">Gambia welcomes British FM for first time since independence </a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>16.2.2017</i></h5>
										<p>British Foreign Secretary Boris Johnson, who in the past sparked fury over comments about Africans, arrives in The Gambia on a charm offensive Tuesday as its new government considers rejoining the Commonwealth.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									<div class="news-grid-left1">
										<img src="images/politic2.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html"> Donald Trump wants ’constructive’ ties with China</a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>20.2.2017</i></h5>
										<p>Uncertainty has prevailed after Trump accused Beijing of unfair trade practices and criticised China’s military buildup.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									<div class="news-grid-left1">
										<img src="images/painting4.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html"> Mexico: Massive anti-Trump rallies staged across nation</a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>13.2.2017</i></h5>
										<p>Marches get under way in some 20 cities across country to protest US President Trump’s anti-Mexican rhetoric.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
							</ul>
