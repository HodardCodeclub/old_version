...
//echo "ok";
//return;
mysqli_query($cn,"UPDATE news_comments SET Accepted='Yes' WHERE CmtID='".@$_GET['comment']."'")or die(mysqli_error($cn));							
}
if($_GET['act']=="deny")
{
//echo "no";
...
<div class="col-sm-9"  style='overflow: scroll;height:480px'>
<?php
