...
<tr><td class="lefttxt">News title</td><td><input type="text" name="t1" required pattern="[a-zA-z _]{3,50}" title"Please Enter Only Characters between 3 to 50 for Package Name" /></td></tr>
...
<tr><td class="lefttxt">Subcategory</td><td><select name="t3" required/><option value="">Select</option>
...
<tr><td class="lefttxt">Short description</td><td><textarea name="t8" style='width:500px;height:100px'></textarea></td></tr>
<tr><td class="lefttxt">Full content</td><td><textarea name="t8" style='width:500px;height:100px'></textarea></td></tr>
<tr><td class="lefttxt">Content picture</td><td><input type="file" name="t5" /></td></tr>
