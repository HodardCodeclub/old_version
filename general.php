							...
							<ul>
								<li>
									<div class="news-grid-left1">
										<img src="images/painting5.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html">Tongo Art Gallery </a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>1.1.2017</i></h5>
										<p>Joe and Sarah have moved so the Tongo Art Gallery has closed. There’s a new art gallery in town! Except… it’s not really that new. […]</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									<div class="news-grid-left1">
										<img src="images/painting1.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html">Ivuka Arts </a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>1.1.2017</i></h5>
										<p>There’s a good chance some of you are already acquainted with Ivuka Arts. If you somehow missed the memo, it gives me great pleasure to […]</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									<div class="news-grid-left1">
										<img src="images/painting2.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html">Yego Arts </a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>1.1.2017</i></h5>
										<p>Yego Arts was closed under mysterious circumstances and they’re currently doing their best to find a new location to re-open. Yego Arts is one of […]</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									<div class="news-grid-left1">
										<img src="images/painting3.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.html"> Inema Arts Center</a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>31.12.2016</i></h5>
										<p>Another art gallery in Kigali! Woohoo!! Meet the Inema Arts Center, located in Kacyiru. It’s actually been around for several months now but I’ve been […]</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								<li>
									...
									<div class="news-grid-right1">
										<h4><a href="single.html"> Uburanga Arts Studio </a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <i>6.1.2017</i></h5>
										<p>Contemporary art is on the rise in Rwanda thanks to studios like Uburanga Arts. Started in March 2012 by Jean Bosco Bakunzi, the studio is […].</p>
									</div>
									<div class="clearfix"> </div>
								</li>
							</ul>
