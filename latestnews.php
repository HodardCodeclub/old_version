...
if(@$_GET['cat']=="miss"){
$sql_articles=mysqli_query($cn,"SELECT news_info.*,news_categories.* FROM news_info,news_categories WHERE news_info.news_category=news_categories.CatID && news_categories.CatNAME='".@$_GET['cat']."' ")or die(mysqli_error($cn));
}
?>
<!DOCTYPE HTML>
<html>
				...
				<div class="news">
					<div class="news-grids">
						<div class="col-md-8 news-grid-left">
							<h3>latest news about Miss</h3>
							<ul>
							<?php 
							while($articles=mysqli_fetch_array($sql_articles)){ ?>
							<li>
									<div class="news-grid-left1">
										<img src="./panel/news_info/news_icons/<?php echo $articles['news_icon'];?>" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
										<h4><a href="single.php?article=<?php echo $articles['news_ID']; ?>"><?php echo $articles['News_Title'];?> </a></h4>
										<h5>By <a href="#">Admin</a> <label>|</label> <?php echo $articles['Published_on'];?></h5>
										<p><?php echo $articles['Short_description'];?></p>
									</div>
